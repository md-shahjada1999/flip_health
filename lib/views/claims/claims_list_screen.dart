          ...
          children: [
            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Obx(
                  () => Column(
                    children: ClaimsController.statusFilters
                        .asMap()
                        .entries
                        .map((entry) {
                          ...
                          final count = controller.getStatusCount(
                            tab['status'] as int,
                          );
      ...
      return RefreshIndicator(
        ...
        child: NotificationListener<ScrollNotification>(
          ...
          child: ListView.builder(
            ...
            itemCount:
                controller.filteredClaims.length +
                (controller.isClaimsLoadingMore.value
                    ? 1
                    : 0), // ignore: unnecessary_statements
