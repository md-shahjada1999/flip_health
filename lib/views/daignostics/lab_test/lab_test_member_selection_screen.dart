...
class LabTestMemberSelectionScreen extends GetView<LabTestController> {
  const LabTestMemberSelectionScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: CommonAppBar.build(title: AppString.kLabTestsTitle),
      body: Obx(() {
        ...
        return Column(
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...controller.sponsoredMembers.map((member) => UserCard(
                            ...
                            isSelected:
                                controller.isUserSelected(member.id),
            ...
            Obx(() => ActionButton(
                  ...
                  onPressed: controller.continueWithMemberSelection,
