...
class MentalWellnessScreen extends GetView<MentalWellnessController> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: CommonAppBar.build(title: AppString.kMentalWellness),
        body: Obx(() {
          ...
          return Column(
            children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16.rh),
                        Obx(() => controller.service.value == 'Mental Wellness'
              ...
              Obx(() => ActionButton(
                    ...
                    backgroundColor: controller.connectEnabled.value ? AppColors.textPrimary : AppColors.textSecondary,
  ...
  Widget _buildServiceChips() {
    const services = ['Mental Wellness', 'Diet & Nutrition', 'Meditation & Healing'];
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        CommonText(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Icon(Icons.arrow_drop_down, color: AppColors.primary, size: 28.rs),
                  ],
                ),
              ),
            )),
        ...
        child: Obx(() => Scrollbar(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) {
                  ...
                  return ListTile(
                    dense: true,
                    title: CommonText(cat, fontSize: 14.rf, color: AppColors.textPrimary),
                    onTap: () {
            ...
            ...MentalWellnessController.availableLanguages.map((lang) {
              return Obx(() => ListTile(
                    ...
                    tileColor: controller.language.value == lang
                        ...
                        : null,
                    leading: Icon(
                      controller.language.value == lang ? Icons.radio_button_checked : Icons.radio_button_off,
                      color: controller.language.value == lang ? AppColors.primary : AppColors.textSecondary,
                      size: 20.rs,
                    ),
                    title: CommonText(lang, fontSize: 14.rf, color: AppColors.textPrimary),
                    onTap: () {
    ...
    return Column(
      ...
      children: [
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            CommonText('** ', fontSize: 13.rf, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
            Expanded(
              child: CommonText(
